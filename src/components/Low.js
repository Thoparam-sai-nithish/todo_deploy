...
let taskDeleted = (id) => {
  ...
  return (
    <div className="border border-2 p- border-success  todosStyles bg-dark    ">
      ...
      <div className="m-0 p-0 row  ">
        ...
        <div className="incomplete m-3 p-3 col-sm-5 row  rounded-4 mx-auto  ">
          <table className="table col-sm-11 rounded-4 text-white  ">
            <h2 className="text-center bg-success  bg-opacity-75 border p-1 rounded-4 m-1 mb-4 ">
              Incomplete Tasks
            </h2>
            {tasks?.map(
              (obj) =>
                obj.taskStatus === "incomplete" &&
                obj.taskPriority === "Low" && (
                  <tr
        ...
        <div className="incomplete m-3 p-3 col-sm-5 row  rounded-4 mx-auto  ">
          <table className="table col-sm-11 rounded-4 text-white  ">
            <h2 className="text-center border bg-success bg-opacity-75 border p-1 rounded-4 m-1 mb-4 ">
              Completed Tasks
            </h2>
            {tasks?.map(
              (obj) =>
