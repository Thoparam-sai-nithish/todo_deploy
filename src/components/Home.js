...
function Home() {
  ...
  return (
    <div className=' bg-dark homeStyles text-white'>
      ...
      <div className="row homeRoutes mt-5">
        <div className="col-sm-6  ">
            <div className="row border border-info rounded-4 m-2  "><h3 className='fs-3 text-end'>Create New Task <button onClick={()=>navigate('/Todos ')} className=" btn mx-5 p-1 px-3 btn-info"><BiPlus/></button></h3></div>
